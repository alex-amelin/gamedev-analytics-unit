...
код ``scripts/``, каталог схемы ``development-docs/``, справочники ``yandex-docs/`` и
манифест ``pyproject.toml`` приходят в хранилище ОТНОСИТЕЛЬНЫМИ символическими ссылками,
